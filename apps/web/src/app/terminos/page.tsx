 ...
 * Reusa el encabezado y el pie del landing para conservar la identidad.
 */
    ...
    <div className="min-h-screen bg-oficina-fondo">
      ...
      <main className="mx-auto max-w-3xl px-6 pt-36 pb-24 lg:px-8">
        ...
        <h1 className="text-4xl font-black leading-[1.1] tracking-tight text-oficina-texto md:text-5xl">
          Términos y Condiciones de SOCRATIA
        </h1>
        <p className="mt-4 text-sm font-medium text-oficina-tenue">
          Versión {LEGAL.terminosVersion} · Vigente desde el {fechaLegalTexto(LEGAL.vigenciaDesde)}
        </p>
        ...
        <div className="mt-8">
          <p className={parrafo}>
            ...
            &ldquo;Proveedor&rdquo;), con domicilio en Cerrada Alzaga 150, Cerradas de Valle
          ...
          <h2 className={titulo}>1. Qué es el Servicio (y qué no es)</h2>
          <p className={parrafo}>
          ...
          <h2 className={titulo}>2. Tu obligación central como Asesor: revisar antes de entregar</h2>
          <p className={parrafo}>
          ...
          <h2 className={titulo}>4. Suscripción, precio y pagos</h2>
          <p className={parrafo}>
          ...
          <h2 className={titulo}>5. Contenido e información</h2>
          <p className={parrafo}>
          ...
          <h2 className={titulo}>6. Uso aceptable</h2>
          <p className={parrafo}>
          ...
          <h2 className={titulo}>7. Datos personales</h2>
          <p className={parrafo}>
          ...
          <h2 className={titulo}>8. Disponibilidad y cambios del Servicio</h2>
          <p className={parrafo}>
          ...
          <h2 className={titulo}>9. Garantías y responsabilidad</h2>
          <p className={parrafo}>
          ...
          <h2 className={titulo}>10. Terminación</h2>
          <p className={parrafo}>
          ...
          <h2 className={titulo}>11. Cambios a estos Términos</h2>
          <p className={parrafo}>
          ...
          <h2 className={titulo}>12. Ley aplicable y tribunales</h2>
          <p className={parrafo}>
          ...
          <h2 className={titulo}>13. Contacto</h2>
          <p className={parrafo}>
